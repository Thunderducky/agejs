...
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }(); // Let's draw a couple things from a scene graph
...
var _grey_sheet = __webpack_require__(5);

var _grey_sheet2 = _interopRequireDefault(_grey_sheet);

var _blue_sheet = __webpack_require__(15);

var _blue_sheet2 = _interopRequireDefault(_blue_sheet);

var _asset_loader = __webpack_require__(6);
...
var _game_text = __webpack_require__(14);
...
loadState.onEnter = function () {
  ...
  Promise.all([(0, _asset_loader2.default)(_grey_sheet2.default), (0, _asset_loader2.default)(_blue_sheet2.default)]).then(function (atlases) {
    ...
    panel = new _panel2.default(panelTexture, 600, 600);
...
var _game_loop = __webpack_require__(8);

var _render_management = __webpack_require__(9);

var _input_management = __webpack_require__(10);
...
var Button = function () {
  function Button(textures, width, height, onclick) {
    ...
    this.node = new _scene_node.SceneNode();
    this.upNode = new _scene_node.SceneNode(this.node); // Button Released
    this.upNode.texture = textures[0];
    this.downNode = new _scene_node.SceneNode(this.node); // Button Pressed
