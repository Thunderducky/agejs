...
(0, _test2.default)(test, function (_atlases) {
  atlases = _atlases;
  console.log(atlases);
...
test.onEnter = function (stepTime, totalTime) {
  ...
  var mouseMonitor = new Monitor().init(root, input_manager.mousePosition, function (mp) {
    return "Mouse Position: " + mp.x + ", " + mp.y;
  });
  var clickMonitor = new Monitor().init(root, input_manager.lastClick, function (lc) {
